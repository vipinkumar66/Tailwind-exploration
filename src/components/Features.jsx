...
const Features = () => {
  return (
    <section className=' container flex flex-col px-4 mx-auto
    mt-10 space-y-12 md:space-y-0 md:flex-row  ' id='features'>
        {/* What's Different */}
            ...
            <div className='flex flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row'>
                ...
                <div>
                    ...
                    <p className='text-darkGrayishBlue'>
                        ...
                        tarcking progress at the milsetone level all the way done to the
